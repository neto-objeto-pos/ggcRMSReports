...
Public Class clsVoidItems
    ...
    Public Function ReportTrans() As Boolean
        ...
        If Not clsRpt.initReport("VoidI") Then
            Return False
        End If
        ...
        loTxtObj.Text = "Void Items (Non-Invoiced) Report"
