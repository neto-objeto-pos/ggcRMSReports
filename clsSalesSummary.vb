...
Public Class clsSalesSummary
    ...
    Public Function ReportTrans() As Boolean
        ...
        If Not clsRpt.initReport("BIRSs") Then
            Return False
        End If
        ...
        loTxtObj.Text = "SALES SUMMARY REPORT"
    ...
    Private Function addRow(ByVal foSchemaTable As DataTable) As DataRow
        ...
        loDtaRow.Item("sField05") = p_sCRMNumbr
        loDtaRow.Item("nField02") = p_nZCounter
        loDtaRow.Item("nField03") = 0
        loDtaRow.Item("nField04") = p_nGrossTtl  'net sales
