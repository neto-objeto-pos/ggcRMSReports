...
Public Class clsCharge
    ...
    Public Function ReportTrans() As Boolean
        ...
        If Not clsRpt.initReport("Chrge") Then
            Return False
        End If
        ...
        loTxtObj.Text = "Charge Sales Transaction Report"
    ...
    Private Function addRow(ByVal lnRow As Integer, ByVal foSchemaTable As DataTable, Optional ByVal lbAddFoot As Boolean = False) As DataRow
        ...
        loDtaRow.Item("sField12") = "Charge sales transaction summary for " & Format(p_dFromDate, xsDATE_LONG) & " to " & Format(p_dThruDate, xsDATE_LONG) & " Transaction"
        loDtaRow.Item("sField01") = Strings.Right(p_oDTSrce(lnRow).Item("sTransNox"), 10)


        loDtaRow.Item("sField07") = p_oDTSrce(lnRow).Item("sCashierx")
