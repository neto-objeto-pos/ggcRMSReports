...
Public Class clsReturns
    ...
    Public Function ReportTrans() As Boolean
        ...
        lsSQL = "SELECT" & _
                  ...
                  " f.nDiscRate," & _
                  " f.nDiscAmtx" & _
                " FROM Return_Detail h " & _
                  " LEFT JOIN Return_Master i" & _
                  "   ON h.sTransNox = i.sTransNox" & _
                  " LEFT JOIN SO_Master a " & _
                    " ON i.sSourceNo = a.sTransNox " & _
                  ...
                  " LEFT JOIN Discount e " & _
                    " ON e.sSourceCd = 'SO' " & _
                      ...
                      " ON e.sDiscCard = f.sCardIDxx" & _
                        " WHERE h.sStockIDx = b.sStockIDx " & _
        ...
        If Not clsRpt.initReport("Retrn") Then
            Return False
        End If
        ...
        loTxtObj.Text = "Sales Return Report"
    ...
    Private Function addRow(ByVal lnRow As Integer, ByVal foSchemaTable As DataTable, Optional ByVal lbAddFoot As Boolean = False) As DataRow
        ...
        loDtaRow.Item("lField01") = p_oDTSrce(lnRow).Item("nUnitPrce") * p_oDTSrce(lnRow).Item("nQuantity")

        loDiscount = p_oDTSrce(lnRow).Item("nUnitPrce") * (IFNull(p_oDTSrce(lnRow).Item("nDiscRate"), 0) / 100)
        loDtaRow.Item("lField03") = loDiscount

        loDtaRow.Item("lField02") = p_oDTSrce(lnRow).Item("nUnitPrce") - loDiscount
